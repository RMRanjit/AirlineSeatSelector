// seating picked from : https://seatmaps.com/airlines/aa-american-airlines/boeing-787/
...
export const  Config = [
  ...
  "rowConfig": [{ 
    ...
    {"seatNumber": "D","position": "2","seatType": "aisle" , position:[0.35, 0, 0.5], rotation:[-0.3, Math.PI, 0], scale:[1.2,1.2,1], occupied: false},
    {"seatNumber": "H","position": "3","seatType": "aisle" , position:[1.60, 0, 0.5], rotation:[-0.3, Math.PI, 0], scale:[1.2,1.2,1], occupied: false},
    {"seatNumber": "L","position": "4","seatType": "window", position:[2.30, 0, 0.5], rotation:[-0.3, Math.PI, 0], scale:[1.2,1.2,1], occupied: true},
    ]
  },
  {
    "row": 2,
    "seats": [
      {"seatNumber": "A","position": "1","seatType": "window", position: [-0.35,0,0.5], rotation: [-0.3,Math.PI,0], scale:[1.2,1.2,1], occupied: true},
      {"seatNumber": "D","position": "2","seatType": "aisle" , position:[0.35, 0, 0.5], rotation:[-0.3, Math.PI, 0], scale:[1.2,1.2,1], occupied: true},
      {"seatNumber": "H","position": "3","seatType": "aisle" , position:[1.60, 0, 0.5], rotation:[-0.3, Math.PI, 0], scale:[1.2,1.2,1], occupied: false},
      {"seatNumber": "L","position": "4","seatType": "window", position:[2.30, 0, 0.5], rotation:[-0.3, Math.PI, 0], scale:[1.2,1.2,1], occupied: true},
      ]
  },
